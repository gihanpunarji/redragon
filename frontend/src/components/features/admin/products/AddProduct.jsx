...
Features:
  ...
  - Warranty included`}
          rows="6"
          className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-800 bg-blue-100 border-2 border-blue-200 rounded-lg focus:outline-none focus:border-red-400 font-mono"
        ></textarea>
      </div>
